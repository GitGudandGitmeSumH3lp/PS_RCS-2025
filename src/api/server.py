...
class APIServer:
    ...
    def _validate_ocr_result(self, result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for field in required_fields:
            ...
            if val is None:
                camel = field_mappings.get(field)
                if camel:
        ...
        try:
            ...
            normalized['confidence'] = float(conf) if conf is not None else 0.0
    ...
    def create_app(self) -> Flask:
        ...
        def trigger_scan() -> Response:
            ...
            try:  # ← CRITICAL: Proper indentation starts HERE
            ...
            except RuntimeError:  # ← CRITICAL: Proper indentation for except
